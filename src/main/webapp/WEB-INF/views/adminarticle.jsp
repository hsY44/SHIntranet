...
<head>
<meta charset="UTF-8">
<title>관리자 게시글 상세보기- SH Company</title>
                ...
                <div class="board">
                    ...
                    <div class="detail-actions">
                        <div class="left-actions">
                            <input type="button" class="page-btn" value="목록으로" onclick="location.href='${pageContext.request.contextPath }/admin/board/list.do?${query }'" />
                        </div>
