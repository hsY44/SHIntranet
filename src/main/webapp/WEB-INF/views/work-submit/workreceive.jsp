	...
	<div class="container">
		...
		<div class="main-wrapper">
            ...
            <div class="content">
				<!-- 타이틀 + 검색 -->
				<div class="contain">
					<span class="board-header">업무 수신 내역</span>
				...
				<div class="board">
					<div class="board-list" id="board-list">
						...
						<div class="board-row board-list-header">
							...
							<span class="board-title">상신</span>
						</div>
						...
						<div id="board-items">
							<c:forEach var="item" items="${result }" varStatus="status">
								<div class="board-row">
									...
									<span class="board-title" ><a href="${pageContext.request.contextPath}/page/aprvrequest.do?parentCd=${item.docCd}"><button type="button">상신하기</button></a></span>
								</div>
							</c:forEach>
						</div>
					</div>
