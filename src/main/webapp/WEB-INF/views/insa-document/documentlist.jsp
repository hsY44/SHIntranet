...
<script type="text/javascript">
	...
	$(function()
	{
		$("#listCount").on("change",function()
		{
			...
			window.location.href = "${pageContext.request.contextPath}/adminList?page=1&listCount=" + $(this).val();
	...
	<div class="container">
		...
		<div class="main-wrapper">
            ...
            <div class="content">
				<!-- 타이틀 + 검색 -->
				<div class="contain">
					<span class="board-header">모든 문서 조회</span>
				...
				<div class="board">
					<div class="board-list" id="board-list">
						...
						<div class="board-row board-list-header">
							...
							<span class="board-title">상위문서코드</span>
							<span class="board-title">문서종류</span>
							<span class="board-title">업무명</span>
							<span class="board-title">제목</span>
							<span class="board-title">등록자</span>
						...
						<div id="board-items">
							<c:forEach var="item" items="${result }" varStatus="status">
								<div class="board-row">
									<a href="${pageContext.request.contextPath}/aprv/detail?docCd=${item.docCd}"></a>
									<span class="board-title">${item.docCd }</span>
									<span class="board-title">${item.parentCd }</span>
									<span class="board-title">${item.typeCd }</span>
									<span class="board-title">${item.workCd }</span>
									<span class="board-title">${item.title }</span>
									<span class="board-title">${item.empCd }</span>
